...
const DATA = {
  singles: [
    ...
    },
    {
      ...
      novel:"ゆりかごの星 / 大河内一楼",
      theme:"主人公スレッタのモビルスーツ「ガンダム・エアリアル」の視点から描かれる物語。エアリアルがスレッタに寄り添い続ける中で問いかける「祝福とは何か」——守ることと愛することの本質を問う。",
      background:"TVアニメ「機動戦士ガンダム 水星の魔女」OPテーマとして制作。シリーズ構成担当の大河内一楼が書き下ろした原作短編小説「ゆりかごの星」はガンダム水星の魔女公式サイトで無料公開中。放送開始直後からSNSで爆発的に拡散し、国内外のアニメファンを一気に獲得したYOASOBIの海外躍進の転換点。",
    ...
    },
    {
      ...
      novel:"レンズ越しの煌めきを / 菜葵（USJコンテスト最優秀作）",
      theme:"未知の世界へ踏み出す恐怖と高揚感。「怖くても、それでも前へ」という冒険者の精神を活気あるサウンドで表現。ユニバーサル・スタジオ・ジャパン（USJ）の体験型アトラクションと連動した冒険心あふれる世界観。",
      background:"THE BOOK 3のリードトラック。最大の特徴はUSJ（ユニバーサル・スタジオ・ジャパン）とのタイアップで、USJ内の体験型アトラクション「XR RIDE ADVENTURE YOASOBI」のテーマ曲として制作された点。実際にUSJの乗り物に乗りながらYOASOBIの楽曲と映像を体験できるという前例のないコラボが実現し、大きな話題を集めた。",
      reception:"プラチナム認定。USJとのコラボにより、音楽ファン以外のテーマパーク来場者にもYOASOBIの楽曲が届いた。ライブのオープニングでも使用されることが多く、観客の熱量を高める楽曲として定着。"
    },
    {
    ...
    {
      title:"Biri-Biri", titleEn:"Biri-Biri", year:2023, date:"2023年11月17日",
    ...
    },
    {
      ...
      novel:"モノトーン / 東村アキコ（映画「ふれる。」コラボ）",
      theme:"白と黒の間に存在する無限のグレー。善悪の二項対立では割り切れない人間の複雑さと、それを受け入れる覚悟。映画「ふれる。」のために書き下ろされた。",
      background:"映画「ふれる。」主題歌として制作。東村アキコが映画のために書き下ろした短編小説が原作。ドーム公演「超現実 Dome Live」開催時期とも重なり、モノクロームのビジュアルが話題に。",

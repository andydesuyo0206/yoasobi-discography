  ...
  profile: {
    ...
    members: [
      ...
      },
      {
        ...
        bio: "幼少期をアメリカ・シカゴで過ごした帰国子女。幼少期よりピアノ・ヴォイストレーニング・クラシックバレエを習い、小学6年生からギターと作詞作曲を始める。中学3年で音楽活動を本格化し、2017年7月よりアコースティックユニット「Pluasonika」に参加（2021年6月卒業）。2021年3月にソロ「幾田りら」としてデビュー。2021年公開のアニメ映画「竜とそばかすの姫」に声優として出演し話題を呼ぶ。YOASOBIではikura名義でボーカルを担当し、透明感と圧倒的な表現力で楽曲に命を吹き込む。",
    ...
    achievements: [
      "「夜に駆ける」ストリーミング累計10億回突破（国内楽曲初）",
      "「アイドル」Billboard Global Excl. U.S.で日本楽曲史上初の1位獲得",
      "「アイドル」Oricon Japan Hot 100で22週1位（21週連続）歴代最長記録",
      "RIAJ認定：累計340万ユニット販売・57億回ストリーミング（2025年8月時点）",
      "2024年 Coachella（アメリカ・最大規模の野外フェス）に出演",
      "2024年 日米首脳会談後のホワイトハウス公式晩餐会に日本代表として招待",
      "2024年 初のドーム公演「超現実 Dome Live」開催（4公演で計17万人動員）",
      "Music Awards Japan 2025にて3部門受賞",
      "TIME誌「2021年ベスト曲10」に「怪物」が選出（5位）",
